...
import 'google_sign_in_success.dart';

class GoogleSignInTry extends StatefulWidget {
  const GoogleSignInTry({Key? key}) : super(key: key);

  @override
  State<GoogleSignInTry> createState() => _GoogleSignInTryState();
}

class _GoogleSignInTryState extends State<GoogleSignInTry> {
  @override
